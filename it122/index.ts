...
//#region Server Routes
    ...
    app.get('/api/pokemon', async (req: Request<PokemonQuery>, res: Response) => {
    ...
    app.post('/api/pokemon', async (req: Request<{}, {}, PokemonBody>, res: Response) => {
    ...
    // Delete API route
    app.delete('/api/pokemon', async (req: Request, res: Response) => {
        const { name } = req.query;
